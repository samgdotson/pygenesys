...
NUCLEAR_ELC = Technology(
    tech_name="NUCLEAR_ELC",
    units="MWe",
...
NUCLEAR_TB = Technology(
    tech_name="NUCLEAR_TB",
    units="MWe",
    tech_sector="electricity",
    tech_label="p",
...
NUCLEAR_CONV = Technology(
    tech_name="NUCLEAR_CONV",
    units="MWe",
    tech_sector="electricity",
    tech_label="pb",
...
NUCLEAR_ADV = Technology(
    tech_name="NUCLEAR_ADV",
    units="MWe",
    tech_sector="electricity",
    tech_label="p",
...
NATGAS_CONV = Technology(
    tech_name="NATGAS_CONV",
    units="MWe",
    tech_sector="electricity",
    tech_label="p",
...
NATGAS_ADV = Technology(
    tech_name="NATGAS_ADV",
    units="MWe",
    tech_sector="electricity",
    tech_label="p",
...
SOLAR_FARM = Technology(
    tech_name="SOLAR_FARM",
    units="MWe",
    tech_sector="electricity",
    tech_label="p",
